...
MAX_TRADE_DURATION_CANDLES = 16  # Time-stop: sai se o trade "cozinhar" por muito tempo
DYNAMIC_SLIPPAGE_B3 = 0.0010    # 0.10% para cobrir spread e taxas de bolsa (mais realista)
CORRELATION_THRESHOLD = 0.7


SYMBOLS = {
    'ITUB4': {
        'ema_short': 15, 'ema_long': 50,
        'rsi_low': 39, 'rsi_high': 65,
        'adx_threshold': 35, 'mom_min': 0.06
    },
    'PETR4': {
        'ema_short': 17, 'ema_long': 98,
        'rsi_low': 31, 'rsi_high': 62,
        'adx_threshold': 29, 'mom_min': 0.04999999999999999
    },
    'RDOR3': {
        'ema_short': 30, 'ema_long': 94,
        'rsi_low': 38, 'rsi_high': 72,
        'adx_threshold': 33, 'mom_min': 0.07
    },
    'WEGE3': {
        'ema_short': 26, 'ema_long': 73,
        'rsi_low': 40, 'rsi_high': 68,
        'adx_threshold': 30, 'mom_min': 0.01999999999999999
    },
    'SANB11': {
        'ema_short': 13, 'ema_long': 73,
        'rsi_low': 25, 'rsi_high': 62,
        'adx_threshold': 32, 'mom_min': 0.009999999999999995
    },
    'B3SA3': {
        'ema_short': 11, 'ema_long': 37,
        'rsi_low': 20, 'rsi_high': 67,
        'adx_threshold': 35, 'mom_min': 0.04999999999999999
    },
    'CSNA3': {
        'ema_short': 7, 'ema_long': 38,
        'rsi_low': 35, 'rsi_high': 75,
        'adx_threshold': 33, 'mom_min': 0.01999999999999999
    },
    'RADL3': {
        'ema_short': 30, 'ema_long': 66,
        'rsi_low': 27, 'rsi_high': 66,
        'adx_threshold': 30, 'mom_min': 0.04000000000000001
    },
    'MGLU3': {
        'ema_short': 29, 'ema_long': 78,
        'rsi_low': 35, 'rsi_high': 65,
        'adx_threshold': 36, 'mom_min': -0.04000000000000001
    },
    'TAEE11': {
        'ema_short': 30, 'ema_long': 72,
        'rsi_low': 20, 'rsi_high': 65,
        'adx_threshold': 36, 'mom_min': 0.01999999999999999
    },
    'CMIG4': {
        'ema_short': 18, 'ema_long': 73,
        'rsi_low': 38, 'rsi_high': 77,
        'adx_threshold': 28, 'mom_min': -0.060000000000000005
    },
    'HYPE3': {
        'ema_short': 10, 'ema_long': 80,
        'rsi_low': 40, 'rsi_high': 77,
        'adx_threshold': 35, 'mom_min': 0.04000000000000001
    },
    'MDIA3': {
        'ema_short': 29, 'ema_long': 63,
        'rsi_low': 29, 'rsi_high': 62,
        'adx_threshold': 20, 'mom_min': -0.03
    },
    'BRKM5': {
        'ema_short': 15, 'ema_long': 77,
        'rsi_low': 24, 'rsi_high': 68,
        'adx_threshold': 16, 'mom_min': 0.06
    },
    'KLBN11': {
        'ema_short': 7, 'ema_long': 71,
        'rsi_low': 21, 'rsi_high': 78,
        'adx_threshold': 18, 'mom_min': 0.06
    },
    'YDUQ3': {
        'ema_short': 13, 'ema_long': 37,
        'rsi_low': 33, 'rsi_high': 68,
        'adx_threshold': 30, 'mom_min': 0.07
    },
    'RECV3': {
        'ema_short': 7, 'ema_long': 71,
        'rsi_low': 27, 'rsi_high': 74,
        'adx_threshold': 16, 'mom_min': 0.06
    },
    'CSAN3': {
        'ema_short': 6, 'ema_long': 36,
        'rsi_low': 22, 'rsi_high': 80,
        'adx_threshold': 26, 'mom_min': 0.009999999999999995
    },
    'ENEV3': {
        'ema_short': 25, 'ema_long': 67,
        'rsi_low': 28, 'rsi_high': 60,
        'adx_threshold': 30, 'mom_min': 0.04000000000000001
    },
    'KEPL3': {
        'ema_short': 29, 'ema_long': 41,
        'rsi_low': 26, 'rsi_high': 77,
        'adx_threshold': 30, 'mom_min': -0.060000000000000005
    },
    'ROMI3': {
        'ema_short': 29, 'ema_long': 35,
        'rsi_low': 20, 'rsi_high': 65,
        'adx_threshold': 36, 'mom_min': 0.09
    },
    'CEAB3': {
        'ema_short': 7, 'ema_long': 57,
        'rsi_low': 30, 'rsi_high': 62,
        'adx_threshold': 15, 'mom_min': -0.060000000000000005
    },
    'HBOR3': {
        'ema_short': 20, 'ema_long': 95,
        'rsi_low': 21, 'rsi_high': 64,
        'adx_threshold': 16, 'mom_min': -0.04000000000000001
    },
    'MDNE3': {
        'ema_short': 23, 'ema_long': 89,
        'rsi_low': 22, 'rsi_high': 70,
        'adx_threshold': 28, 'mom_min': 0.0
    },
    'CASH3': {
        'ema_short': 29, 'ema_long': 55,
        'rsi_low': 23, 'rsi_high': 63,
        'adx_threshold': 31, 'mom_min': 0.04999999999999999
    },
    'AURA33': {
        'ema_short': 29, 'ema_long': 100,
        'rsi_low': 31, 'rsi_high': 75,
        'adx_threshold': 25, 'mom_min': -0.04000000000000001
    },
    'CSED3': {
        'ema_short': 30, 'ema_long': 92,
        'rsi_low': 39, 'rsi_high': 64,
        'adx_threshold': 31, 'mom_min': 0.0
    },
    'EALT3': {
        'ema_short': 27, 'ema_long': 99,
        'rsi_low': 24, 'rsi_high': 74,
        'adx_threshold': 25, 'mom_min': 0.04000000000000001
    },
}
